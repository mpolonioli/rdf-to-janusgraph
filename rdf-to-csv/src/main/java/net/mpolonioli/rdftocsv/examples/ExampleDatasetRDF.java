...
public class ExampleDatasetRDF {
	...
	public static void main(String[] args) throws IOException, ParserException {
		...
		File datasetRDF = new File("example-resources" + s + "test-dataset-rdf" + s + "input-rdf");
		String baseURI = "http://www.example.com/";
		RDFNotation rdfNotation = RDFNotation.TURTLE;
		File outputDirHDT = new File("example-resources" + s + "example-dataset-rdf" + s + "output-hdt");
		File outputDirEdgeCsv = new File("example-resources" + s + "example-dataset-rdf" + s + "output-csv" + s + "edges");
		File outputDirVertexCsv = new File("example-resources" + s + "example-dataset-rdf" + s + "output-csv" + s + "vertices"); 
		...
		rdfToCsv.createCsvFiles(datasetRDF, baseURI, rdfNotation, outputDirHDT, outputDirVertexCsv, outputDirEdgeCsv, classNames, vertexNames, propertyNames, classHasUri, subClassOf, propertyHasUri, propertyHasCardinality, edgeHasUri, vertexHasProperties);
	}
